...
HTMLPROOFER_OPTIONS="./_site --internal-domains=pid.codes --check-html --check-opengraph --report-missing-names --log-level=:debug --url-ignore /www.andreas.org/,/www.kbles.ru/,/instantinfrastructure.org/,/github.com\/KK2345\/TinyPassword$/,/github.com\/KK2345\/TinyPassword\/blob\/master\/README.md/,/www.oshec.org\/projects\/pi-pilot\/wiki/,/github.com\/Misfittech\/nano_stepper\/blob\/master\/hardware\/Nano%20Zero%20R1.0.pdf/,/github.com\/xuio\/Cynteract$/,/github.com\/mattomatto\/craft$/"
